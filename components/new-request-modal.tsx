            ...
            <div style={{ ...cardStyle, display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                <h3 style={{
                  ...
                  color: '#0f172a',
                  margin: '0 0 4px'
                }}>Enter USDOT Number</h3>
                <p style={{
                  fontSize: '13px',
                  color: '#64748b',
                  margin: 0
                }}>We&apos;ll pull the carrier&apos;s info and insurance history from FMCSA.</p>
              </div>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  color: '#475569',
                  margin: '0 0 8px'
                }}>WHAT GETS PULLED AUTOMATICALLY</p>
                <div style={{
                  display: 'grid',
            ...
            <>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button
                  ...
                  style={{
                    ...btnP,
                    opacity: submitting || !form.companyName ? 0.6 : 1
                  }}
