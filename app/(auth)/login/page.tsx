          ...
          {/* Left branding panel */}
                <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-12"
                            ...
                            {/* Logo */}
                                    <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-white font-bold text-lg tracking-tight">
                                                              LossRun<span style={{ color: '#FFB347' }}>360</span>span>
                                                </span>span>
                                    </div>div>
                            ...
                            {/* Headline */}
                                    <div className="mt-16">
                                                ...
                                                <p className="mt-4 text-base" style={{ color: 'rgba(255,255,255,0.72)' }}>
                                                              The professional platform built for commercial trucking insurance agencies. Request, track, and manage loss runs — all in one place.
                                                </p>p>
                                    </div>div>
                        ...
                        <p className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>
                                  © {new Date().getFullYear()} LossRun360. All rights reserved.
                        </p>p>
                </div>div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
                {/* Mobile logo */}
                      ...
                      <div className="w-full max-w-sm">
                                <div className="mb-8">
                                            <h1 className="text-2xl font-bold" style={{ color: '#0D1C38' }}>
                                                          Welcome back
                                            </h1>h1>
                        ...
                        {/* Form card */}
                                <div className="bg-white rounded-2xl p-8" style={{ boxShadow: '0 2px 16px rgba(14,28,62,0.10), 0 0 0 1px rgba(14,28,62,0.06)' }}>
                                            <form onSubmit={handleSubmit} className="space-y-5">
                                                          <div>
                                                                          ...
                                                                          <input
                                                                                              ...
                                                                                              autoFocus
                                                                                              onFocus={e => {
                                                                                                                    e.currentTarget.style.border = '1px solid #1654D9'
                                                                                                                                          e.currentTarget.style.boxShadow = '0 0 0 3px rgba(22,84,217,0.12)'
                                                                                                }}
                                                                                              onBlur={e => {
                                  ...
                                  {/* Demo credentials */}
                                            <div className="mt-6 pt-5" style={{ borderTop: '1px solid #EEF2F8' }}>
                                                          ...
                                                          <button
                                                                            ...
                                                                            className="w-full px-3 py-2.5 rounded-lg text-xs transition-colors text-left"
                                                                          ...
                                                                          >
                                                                          <span className="font-semibold" style={{ color: '#0D1C38' }}>
                                                                                            demo@apexinsurance.com
                                                                          </span>span>
                                                            {' · '}Demo@123!
                                                          </button>button>
                                            </div>div>
