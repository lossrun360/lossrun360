    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: '#f8fafc', fontFamily: "'Inter', system-ui, sans-serif" }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {[
              ...
              <div key={feat} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ width: '20px', height: '20px', borderRadius: '3px', background: 'rgba(28,110,221,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 24px' }}>
        ...
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '4px', padding: '28px', border: '1px solid #e2e8f0', boxShadow: '0 4px 24px rgba(15,23,42,0.06)' }}>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  autoFocus
                  style={{ width: '100%', padding: '9px 12px', border: '1px solid #e2e8f0', borderRadius: '4px', fontSize: '14px', color: '#0f172a', background: '#f8fafc', outline: 'none', boxSizing: 'border-box' }}
              ...
              <button
                type="submit"
                disabled={loading}
                style={{ width: '100%', padding: '10px', borderRadius: '4px', background: loading ? '#93c5fd' : '#1c6edd', color: '#fff', fontSize: '14px', fontWeight: '600', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', transition: 'background 0.15s', boxShadow: '0 1px 3px rgba(28,110,221,0.3)' }}
            ...
            <div style={{ marginTop: '20px', paddingTop: '18px', borderTop: '1px solid #f1f5f9' }}>
              ...
              <button
                ...
                style={{ width: '100%', padding: '9px 12px', borderRadius: '4px', background: '#f8fafc', border: '1px solid #e2e8f0', fontSize: '12px', color: '#475569', cursor: 'pointer', textAlign: 'left', transition: 'background 0.1s' }}
